        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link me-2" href="profile.php">
                        <i class="fa fa-user opacity-6 text-dark me-1"></i> My Profile
                    </a>
                </li> -->
                <!-- <li class="nav-item">
            ...
            <ul class="navbar-nav d-lg-flex d-none">
                <li class="nav-item d-flex align-items-center">
                    <a class="btn btn-outline-primary btn-sm mb-0 me-2" target="_blank" href="#">Learn More</a>
                </li>
                <li class="nav-item">
                    <a href="./" class="btn btn-sm mb-0 me-1 bg-gradient-dark">Back to Dashboard</a>
                </li>
            </ul>
        </div>
    </div>
