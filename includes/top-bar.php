...
try {
    ...
    foreach ($results as $result) {
        ...
        $_SESSION['fname'] = $fname = $result->fullname;
        $role = $result->role;
        $active_since = $result->created_at;
    }
    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Hello <b><?php echo $uname; ?></b>, Welcome to <b>Datalytics</b></li>
            </ol>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav d-flex align-items-center  justify-content-end">
                <li class="nav-item d-flex align-items-center">
                    <a class="btn btn-outline-primary btn-sm mb-0 me-3 text-uppercase" target="_blank" href="#">
                ...
                <li class="nav-item d-flex align-items-center">
                    <a href="#" class="nav-link text-body font-weight-bold px-0">
                        <i style="font-size: 30px" class="material-symbols-rounded">account_circle</i>
                    </a>
                </li>
            </ul>
        </div>
