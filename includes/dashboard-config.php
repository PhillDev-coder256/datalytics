    ...
    <div class="card shadow-lg">
        <div class="card-header pb-0 pt-3">
            <div class="float-start">
                <h5 class="mt-3 mb-0">Datalytics Configurator</h5>
        ...
        <div class="card-body pt-sm-3 pt-0">
            ...
            <a class="btn bg-gradient-info w-100" href="https://www.creative-tim.com/product/material-dashboard-pro">View Profile</a>
